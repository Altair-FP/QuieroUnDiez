...
{
    public class SecurityStudentAdmin : IActionFilter
    {
        private readonly QuieroUnDiezDBContex _context;

        public SecurityStudentAdmin(QuieroUnDiezDBContex context)
        {
            _context = context;
        }
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            else if (!role.Name.ToUpper().Equals("STUDENT") && !role.Name.ToUpper().Equals("ADMIN"))
            {
